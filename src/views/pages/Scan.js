...
class Scan extends Component {
  ...
  submitButton() {
    ...
    if(currentStep === 3) {
      return (
        <Row>
          <Link to={{pathname: "/maps", state:{data: data}}} style={{margin: "60px auto 20px"}}>
          Submit
          </Link>
        </Row>
      )
        ...
        <Row>
          <Col md={6}>
            <div className="home-hero">
              <h1>Scan the QR code on your bike!</h1>
              <p className="text-muted">
                Use the camera of the phone to scan the QR Code on the bike.
              </p>
            </div>
          </Col>
        </Row>
          ...
          <Col md={{ size: 8, offset: 2 }}>
            ...
            <Form>
              <FormGroup>
                ...
                <Input valid={props.state.success.bikeId === "c"} invalid={props.state.success.bikeId === "w"} type="text" name="bikeId" id="bikeId" placeholder="Bike Id" onChange={props.onChange} value={props.state.bikeId} autoComplete="off"/>
          ...
          <Col md={{ size: 8, offset: 2 }}>
            <Form>
              <FormGroup>
                ...
                <Input valid={props.state.success.distance === "c"} invalid={props.state.success.distance === "w"} type="text" name="distance" id="distance" placeholder="Distance" onChange={props.onChange} value={props.state.distance} autoComplete="off"/>
                <FormFeedback invalid>Distance cannot be empty</FormFeedback>
              </FormGroup>
              <FormGroup>
  ...
  return(
    <React.Fragment>
        ...
        <Row>
            ...
            <Col md={6}>
              <Card className="text-center">
                <CardHeader tag="h3"><h2>Distance</h2></CardHeader>
                <CardBody>
        ...
        <Row>
            <Col md={{size: 6, offset: 3}}>
              <Card className="text-center">
                <CardHeader tag="h3"><h2>Bike Id</h2></CardHeader>
                <CardBody>
